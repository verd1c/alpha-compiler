...
funcdef     :   funcstart LEFT_PARENTHESIS {scope++; idexprlist=mkExprList();} idlist {patchExprList(idexprlist); enterscopespace(); resetfunctionlocalsoffset();} RIGHT_PARENTHESIS  
                    {    
                        scope--; 
                        _func_count++;
