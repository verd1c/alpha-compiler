...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ifstart = 79,                   /* ifstart  */
  YYSYMBOL_whilestmt = 80,                 /* whilestmt  */
  YYSYMBOL_whilestart = 81,                /* whilestart  */
  YYSYMBOL_forstmt = 82,                   /* forstmt  */
  YYSYMBOL_forstart = 83,                  /* forstart  */
...
static const yytype_int16 yyrline[] =
{
      ...
      85,    92,   100,   101,   102,   105,   106,   107,   108,   109,
     110,   111,   112,   113,   114,   115,   116,   117,   118,   119,
     122,   123,   124,   125,   154,   183,   212,   241,   245,   244,
     276,   301,   302,   303,   304,   307,   327,   349,   363,   367,
     368,   369,   370,   373,   374,   402,   405,   406,   409,   411,
     413,   414,   415,   418,   419,   422,   423,   426,   429,   430,
     433,   437,   442,   443,   446,   446,   446,   464,   490,   504,
     504,   504,   504,   504,   506,   507,   508,   511,   527,   528,
     531,   533,   535,   537,   539,   541,   542
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$@2", "$@3", "funcstart", "const", "idlist", "arg", "ifstmt", "ifstart",
  "whilestmt", "whilestart", "forstmt", "forstart", "returnstmt", YY_NULLPTR
};
...
#line 1412 "parser.c"
  ...
  case 11: /* statement: CONTINUE SEMICOLON  */
#line 92 "parser.y"
                                        { 
                                            if(scope==0 && _in_control==0){
...
#line 1877 "parser.c"
  ...
  case 90: /* ifstart: IF LEFT_PARENTHESIS  */
#line 531 "parser.y"
                                    { _in_control++; printf("line: %d: if statement\n", yylineno); }
#line 1883 "parser.c"
    break;

  case 92: /* whilestart: WHILE LEFT_PARENTHESIS  */
#line 535 "parser.y"
                                       { _in_control++; printf("line: %d: while statement\n", yylineno);}
#line 1889 "parser.c"
    break;

  case 94: /* forstart: FOR LEFT_PARENTHESIS  */
#line 539 "parser.y"
